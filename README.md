...
- [Migrate from `PublishVisualStudioExtension@5` to GitHub Actions (`jessehouwing/vs-marketplace@v0.9.0`)](./docs/migrate-from-publishvsextension-to-github-actions.md)
- [Migrate from Azure Pipelines (`vs-marketplace@6`) to GitHub Actions (`jessehouwing/vs-marketplace@v0.9.0`)](./docs/migrate-from-azure-pipelines-to-github-actions.md)
