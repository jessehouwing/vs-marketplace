...
extension) to the `jessehouwing/vs-marketplace@v0.9.16` GitHub Actions action.

## Migration approach

1. Move your pipeline trigger to a GitHub Actions workflow `on:` block.
2. Replace the `PublishVisualStudioExtension@5` step with `jessehouwing/vs-marketplace@v0.9.16`.
...
| `PublishVisualStudioExtension@5` input               | `jessehouwing/vs-marketplace@v0.9.16` input | Notes                                                          |
| ---------------------------------------------------- | ------------------------------------------- | -------------------------------------------------------------- |
...
2. Add an `azure/login@v2` step before `jessehouwing/vs-marketplace@v0.9.16`.
...
### After (`jessehouwing/vs-marketplace@v0.9.16` with PAT)
  ...
  publish:
    ...
    steps:
      ...
      - name: Publish to VS Marketplace
        uses: jessehouwing/vs-marketplace@v0.9.16
        with:
          auth-type: pat
...
### After (`jessehouwing/vs-marketplace@v0.9.16` with OIDC)
