...
`jessehouwing/vs-marketplace@v0.9.16` GitHub Actions action.

## Migration approach

1. Move your pipeline trigger to a GitHub Actions workflow `on:` block.
2. Replace the `vs-marketplace@6` task step with `jessehouwing/vs-marketplace@v0.9.16`.
...
| `vs-marketplace@6` input                                              | `jessehouwing/vs-marketplace@v0.9.16` input | Notes                                                          |
| --------------------------------------------------------------------- | ------------------------------------------- | -------------------------------------------------------------- |
